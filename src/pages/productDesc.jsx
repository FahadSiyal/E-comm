  ...
  return (
    <div className='bg-white p-10'>
      <div className="max-w-5xl mx-auto p-4 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <img src={product.image || "./children-sample.jpg"} alt={product.name} className="rounded-lg h-100 w-full border-3 border-gray-300" />
        ...
        <Card className='bg-transparent shadow-none'>
          <CardContent className="space-y-4 pt-4">
            ...
            <div className="flex space-x-4">
              ...
              <Link to="/checkout" state={{ product }} className="flex-1">

  ...
  return (
    <div className='bg-white p-10'>
      <div className="max-w-5xl mx-auto p-4 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <img src={product.image || "./men-sample.jpg"} alt={product.name} className="rounded-lg h-100 w-full border border-3 border-gray-300 hover:scale-105 transition-transform duration-300" />
        ...
        <Card className='bg-transparent shadow-none'>
          <CardContent className="space-y-4 pt-4">
            ...
            <div className="text-red-600 text-xl font-bold text-orange-600">
              Rs {product.actualprice}
              <span className="text-sm line-through text-gray-500 ml-2">
                Rs {product.price}
              </span>
              <span className="text-green-600 text-sm ml-1">25% OFF</span>
            </div>
